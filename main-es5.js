...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppRunRunComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAccountAccountComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _display_display_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    ...
    /*#__PURE__*/
    function () {
      function AccountComponent(accountService, detect, displayService) {
      ...
      _createClass(AccountComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.accountService.getAccount().then(function (data) {
            ...
            _this.accountService.select = data['id'];
            _this.selectAccount = data['id'];

            _this.select(_this.selectAccount);
          });
        }
      }, {
        key: "add",
        value: function add(e) {
          ...
          if (this.addaccount != "" && !this.accountService.accountarr.some(function (data) {
            return data.account == e;
          }) && e != undefined) {
            this.accountService.saveAccount(e).then(function (data) {
              _this2.accountService.accountarr.unshift({
                id: data['id'],
                account: data['account']
              });

              _this2.accountService.select = data['id'];
              _this2.selectAccount = _this2.accountService.select;
              console.log(data);
              console.log(_this2.accountService.accountarr);
            });
            this.selectAccount = this.accountService.select;
          }
        }
        ...
        value: function select(e) {
          ...
          this.displayService.getDataAccount(e).then(function () {
            _this3.displayService.data = [];
            _this3.displayService.money = [];
            console.log(_this3.displayService.data);
          });
        }
      }]);
  ...
  function srcAppAccountAccountServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _app_url__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../app.url */
    "./src/app/app.url.ts");
    ...
    function () {
      ...
      _createClass(AccountService, [{
        key: "saveAccount",
        value: function saveAccount(e) {
          return this.http.post("".concat(_app_url__WEBPACK_IMPORTED_MODULE_3__["AppUrl"].BackEndUrl, "/account"), {
            account: e
          }).toPromise();
        }
      }, {
        ...
        value: function getAccount() {
          ...
          return new Promise(function (resolve, reject) {
            _this4.http.get("".concat(_app_url__WEBPACK_IMPORTED_MODULE_3__["AppUrl"].BackEndUrl, "/account")).toPromise().then(function (data) {
              //console.log(this.accountarr[0])
              if (_this4.accountarr[0] != undefined) {} else {
                for (var i = 0; i < Object.keys(data).length; i++) {
                  _this4.accountarr.push({
                    id: data[i]['id'],
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _run_run_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./run/run.component */
    ...
    var _account_account_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    ...
    var _run_run_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./run/run.service */
    ...
    var appRoutes = [{
      ...
      path: 'run',
      component: _run_run_component__WEBPACK_IMPORTED_MODULE_6__["RunComponent"]
    }, {
      path: 'display',
  ...
  function srcAppDisplayDisplayComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _run_run_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../run/run.service */
    "./src/app/run/run.service.ts");
    /* harmony import */
    ...
    var _display_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./display.service */
    "./src/app/display/display.service.ts");
    /* harmony import */
    ...
    /*#__PURE__*/
    function () {
      function DisplayComponent(runService, accountService, displayService, router) {
      ...
      _createClass(DisplayComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.accountService.getAccount().then(function (data) {
            console.log(data);
            _this5.accountService.select = data['id'];
            _this5.selectAccount = data['id'];
            _this5.selectAccount = _this5.accountService.select;

            _this5.select(_this5.selectAccount);
          });
        ...
        value: function select(e) {
          ...
          this.accountService.select = e;
          this.selectAccount = this.accountService.select;
          this.displayService.getDataAccount(this.selectAccount).then(function () {
            _this6.displayService.data = [];
            _this6.data = _this6.displayService.data;
            _this6.displayService.money = [];
            _this6.money = _this6.displayService.money; //console.log(this.money)
          });
        }
      }, {
        key: "clickEvent",
        value: function clickEvent(i) {
        ...
        value: function check(i) {
          if ("toggle" + i == this.toggle) {
            if (this.status) return "show";else return "hide";
          } else {
            return "hide";
          }
        }
        ...
        key: "delete",
        value: function _delete(id, index, type, price) {
          if (type == "receive") {
            console.log(type);
  ...
  /***/
  function srcAppDisplayDisplayServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "DisplayService", function () {
    ...
    function () {
      ...
      _createClass(DisplayService, [{
        key: "getDataAccount",
        value: function getDataAccount(e) {
          var _this7 = this;

          return new Promise(function (resolve, reject) {
            _this7.http.post("".concat(_app_url__WEBPACK_IMPORTED_MODULE_3__["AppUrl"].BackEndUrl, "/data"), {
              account_id: e
            }).toPromise().then(function (get) {
              console.log(get);

              if (_this7.data[0] != undefined && _this7.money[0] != undefined) {} else {
                ...
                _this7.money.push(get['money']); //console.log(this.money)


                for (var i = 0; i < Object.keys(get['account']).length; i++) {
                  _this7.data.push({
                    id: get['account'][i]['id'],
                    account_id: get['account'][i]['account_id'],
                    type: get['account'][i]['type'],
                    price: get['account'][i]["price"],
                    detail: get['account'][i]["detail"],
                    created: get['account'][i]['created'],
                    update: get['account'][i]["updated"]
                  });
                }

                console.log(_this7.money);
              }
            });
        ...
        key: "DelectDataAccount",
        value: function DelectDataAccount(id) {
          this.http.post("".concat(_app_url__WEBPACK_IMPORTED_MODULE_3__["AppUrl"].BackEndUrl, "/delete"), {
            id: id
    ...
    DisplayService.ctorParameters = function () {
      return [{
        type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]
      }];
    };

    DisplayService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])()], DisplayService);
    /***/
  },
  ...
  /***/
  function srcAppRunRunComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppRunRunComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "RunComponent", function () {
      return RunComponent;
    });
    /* harmony import */
    ...
    var _run_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./run.service */
    "./src/app/run/run.service.ts");
    /* harmony import */


    var _display_display_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../display/display.service */
    "./src/app/display/display.service.ts");
    ...
    /*#__PURE__*/
    function () {
      function RunComponent(account, run, displayService) {
        _classCallCheck(this, RunComponent);
      ...
      _createClass(RunComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this8 = this;

          this.accountlist = this.account.accountarr;
          this.account.getAccount().then(function (data) {
            //console.log(data)
            _this8.account.select = data['id'];
            _this8.selectAccount = data['id'];

            _this8.displayService.getDataAccount(_this8.selectAccount).then(function () {});
          });
          ...
          if (this.id != undefined) {
            console.log(this.id); //this.data.push(this.displayService.data.find(data=>data['id']))

            this.displayService.data.find(function (data) {
              if (data.id == _this8.id) {
                _this8.type = data.type;
                _this8.detail = data.detail;
                _this8.monValue = data.price;
              }
            }); //this.type =
          }
        }
        ...
        value: function select(e) {
          ...
          this.displayService.getDataAccount(e).then(function () {
            _this9.displayService.data = [];
            _this9.displayService.money = [];
            console.log(_this9.displayService.data);
          });
        }
      }, {
        key: "save",
    ...
    RunComponent.ctorParameters = function () {
      return [{
    ...
    RunComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-run',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./run.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/run/run.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./run.component.scss */
      "./src/app/run/run.component.scss")).default]
    })], RunComponent);
    /***/
  },
  ...
  /***/
  function srcAppRunRunServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "RunService", function () {
      return RunService;
    });
    /* harmony import */
    ...
    var _app_url__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ../app.url */
    "./src/app/app.url.ts");
    ...
    /*#__PURE__*/
    function () {
      function RunService(accountService, http, displayService, router) {
        _classCallCheck(this, RunService);
      ...
      _createClass(RunService, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }, {
        key: "testsave",
        value: function testsave(a, t, d, p, id) {
          var _this10 = this;

          this.http.post("".concat(_app_url__WEBPACK_IMPORTED_MODULE_6__["AppUrl"].BackEndUrl, "/run"), {
            account: a,
            type: t,
            detail: d,
            price: p,
            ...
            _this10.displayService.getDataAccount(a).then(function () {
              _this10.displayService.data = [];
              _this10.displayService.money = [];
              console.log(_this10.displayService.data);

              _this10.router.navigate(['/display']);
            });
          });
        }
      }]);
    ...
    RunService.ctorParameters = function () {
      return [{
        type: _account_account_service__WEBPACK_IMPORTED_MODULE_2__["AccountService"]
      }, {
    ...
    RunService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])()], RunService);
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\Sources\Desktop\new test\proj\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
